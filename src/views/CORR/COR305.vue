        ...
        <v-row class="input-row">
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <FECHA
              ...
              "
              @onChange="
                (data) => (reg_distribucion_interna.fecha_init = data.value)
              "
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <FECHA
              ...
              "
              @onChange="(data) => (reg_distribucion_interna.fecha_fin = data.value)"
...
export default {
  ...
  methods: {
    onChange(data) {
      this.reg_distribucion_interna[data.key] = data.value;
    },
    ...mapMutations({
