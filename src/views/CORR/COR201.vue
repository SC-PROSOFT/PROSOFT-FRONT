  ...
  <v-container fluid>
    ...
    <v-card elevation="20" class="px-4 py-4 mx-auto">
      ...
      <v-row justify="start" align="center" class="input-row">
        ...
        <v-col cols="12" sm="2" md="2" xs="2" class="input-col">
          <AUTOCOMPLETE @next-action="nextStep(form_corres, $event, datoManejo)" :field="form_corres.manejo" :reg="reg.manejo" @onChange="onChange" />
        </v-col>
        <v-col cols="12" sm="2" md="2" xs="2" class="input-col">
          <AUTOCOMPLETE
        ...
        <v-col cols="12" sm="2" md="2" xs="2" class="input-col">
          <FECHA @next-action="nextStep(form_corres, $event, datoFecha)" :field="form_corres.fecha" :reg="reg.fecha" @onChange="onChange" />
        </v-col>
        <v-col cols="12" sm="2" md="2" xs="2" class="input-col">
          <data-card @next-action="nextStep(form_corres, $event)" :field="form_corres.hora" :reg="reg.hora" @onChange="onChange" />
        </v-col>
      </v-row>
      <v-row justify="start" align="center" class="input-row" v-if="flag_radicados">
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <INPUT
            ...
            @onChange="(data) => (reg_ant[data.key] = data.value)"
          />
        </v-col>
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
      ...
      <v-row justify="start" align="center" class="input-row">
        ...
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <data-card :field="form_corres.descripDeptoremi" :reg="reg.descripDeptoremi" />
        </v-col>
        <v-col cols="12" sm="2" md="2" xs="2" class="input-col">
          <INPUT
        ...
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <data-card :field="form_corres.descripTipco" :reg="reg.descripTipco" />
        </v-col>
        <v-col cols="12" sm="2" md="2" xs="2" class="input-col">
      ...
      <v-row justify="start" align="center" class="input-row">
        ...
        <v-col cols="12" sm="6" md="6" xs="6" class="input-col">
          <INPUT @next-action="nextStep(form_corres, $event, datoDescrip)" :field="form_corres.descrip" :reg="reg.descrip" @onChange="onChange" />
        </v-col>
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <INPUT
        ...
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <data-card :field="form_corres.responsableDep" :reg="reg.responsableDep" />
        </v-col>
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <INPUT @next-action="nextStep(form_corres, $event, datoFol)" :field="form_corres.fol" :reg="reg.fol" @onChange="onChange" />
        </v-col>
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <INPUT @next-action="nextStep(form_corres, $event, datoFolD)" :field="form_corres.fold" :reg="reg.fold" @onChange="onChange" />
        </v-col>
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <INPUT @next-action="nextStep(form_corres, $event, datoAnex)" :field="form_corres.anex" :reg="reg.anex" @onChange="onChange" />
        </v-col>
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <AUTOCOMPLETE
        ...
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <INPUT @next-action="nextStep(form_corres, $event, datoFactura)" :field="form_corres.nroFact" :reg="reg.nroFact" @onChange="onChange" />
        </v-col>
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <INPUT @next-action="nextStep(form_corres, $event, datoMonto)" :field="form_corres.monto" :reg="reg.monto" @onChange="onChange" />
        </v-col>
        <v-col cols="12" sm="3" md="3" xs="3" class="input-col">
          <FECHA
        ...
        <v-col cols="12" sm="4" md="4" xs="4" class="input-col">
          <INPUT @next-action="nextStep(form_corres, $event, datoNroGuia)" :field="form_corres.nroGuia" :reg="reg.nroGuia" @onChange="onChange" />
        </v-col>
        <v-col cols="12" sm="4" md="4" xs="4" class="input-col">
          <INPUT
    ...
    <v-dialog v-model="show_archivo_abjunto" width="500">
      <v-card width="500">
        ...
        <v-container>
          <FILEINPUT :field="form_corres.archivo_file" :reg="reg.archivo_file" @onChange="onChange" class="ma-10" />
...
export default {
  ...
  methods: {
    ...
    async validarContAnt() {
      try {
        const llave = {
          anoLlave: JSON.stringify(this.reg_ant.contAtnt)?.slice(0, 4),
          cont: JSON.stringify(this.reg_ant.contAtnt)?.slice(4),
        };
    ...
    async condicionesNovedad() {
      if (this.novedad.acceso == "7" || !this.reg.contAtnt) this.focusInput(this.form_corres);
