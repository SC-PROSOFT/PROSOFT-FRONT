      ...
      <v-row>
        ...
        <v-col cols="12" sm="4" md="4" class="input-col">
          <data-card
            ...
            :reg="reg_COR401.remitente_dataCard"
          ></data-card>
        </v-col>
        ...
        <v-col cols="12" sm="4" md="4" class="input-col">
          <data-card
            ...
            :reg="reg_COR401.depto_remit_dataCard"
          ></data-card>
        </v-col>
        ...
        <v-col cols="12" sm="4" md="4" class="input-col">
          <data-card
            ...
            :reg="reg_COR401.aux_tip_dataCard"
          ></data-card>
        </v-col>
        ...
        <v-col cols="12" sm="4" md="4" class="input-col">
          <data-card
            ...
            :reg="reg_COR401.drig_depto_dataCard"
          ></data-card>
        </v-col>
        ...
        <v-col cols="12" sm="2" md="2" xs="2" class="input-col">
          <INPUT
            ...
            :reg="reg_COR401.personal_destino"
            @onChange="onChange"
          ></INPUT>
        </v-col>
        <v-col cols="12" sm="4" md="4" class="input-col">
          <data-card
            ...
            :reg="reg_COR401.personal_destino_dataCard"
          ></data-card>
        </v-col>
        ...
        <v-col cols="12" sm="2" md="2" class="input-col">
          <FECHA
            ...
            :reg="reg_COR401.fecha_documento"
          ></FECHA>
        </v-col>
        ...
        <v-col cols="12" sm="2" md="2" class="input-col">
          <data-card
            ...
            :reg="reg_COR401.centro_costos_dataCard"
          ></data-card>
        </v-col>
        ...
        <v-col cols="12" sm="4" md="4" class="input-col">
          <INPUT
            ...
            :reg="reg_COR401.persona_entrega_corres"
            @onChange="onChange"
          ></INPUT>
        </v-col>
