        ...
        <v-row class="input-row">
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <INPUT
              ...
              :reg="reg_control_respuestas.entidad"
              @onChange="onChange"
            ></INPUT>
          </v-col>
          <v-col cols="12" sm="4" md="4" class="input-col">
            <data-card
              ...
              :reg="reg_control_respuestas.entidad_dataCard"
              @onChange="onChange"
            ></data-card>
          </v-col>
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <INPUT
              ...
              :reg="reg_control_respuestas.depen_corres"
              @onChange="onChange"
            ></INPUT>
          </v-col>
          <v-col cols="12" sm="4" md="4" class="input-col">
            <data-card
              ...
              :reg="reg_control_respuestas.depen_corres_dataCard"
              @onChange="onChange"
            ></data-card>
          </v-col>
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <INPUT
              ...
              :reg="reg_control_respuestas.tipo_corres"
              @onChange="onChange"
            ></INPUT>
          </v-col>
          <v-col cols="12" sm="4" md="4" class="input-col">
            <data-card
              ...
              :reg="reg_control_respuestas.tipo_corres_dataCard"
              @onChange="onChange"
            ></data-card>
          </v-col>
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <FECHA
              ...
              "
              @onChange="
                (data) => (reg_control_respuestas.fecha_init = data.value)
              "
              :field="form_control_respuestas.fecha_init"
              :reg="reg_control_respuestas.fecha_init"
            ></FECHA>
          </v-col>
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <FECHA
              ...
              :reg="reg_control_respuestas.fecha_fin"
              @onChange="
                (data) => (reg_control_respuestas.fecha_fin = data.value)
              "
            ></FECHA>
          </v-col>
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <AUTOCOMPLETE
              ...
              :reg="reg_control_respuestas.jornada"
              @onChange="onChange"
            ></AUTOCOMPLETE>
          </v-col>
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <AUTOCOMPLETE
              ...
              :reg="reg_control_respuestas.procedencia"
              @onChange="onChange"
            ></AUTOCOMPLETE>
          </v-col>
          ...
          <v-col cols="12" sm="2" md="2" class="input-col">
            <AUTOCOMPLETE
              ...
              :reg="reg_control_respuestas.manejo"
              @onChange="onChange"
            ></AUTOCOMPLETE>
          </v-col>
        </v-row>
...
export default {
  ...
  methods: {
    onChange(data) {
      console.log(data);
      this.reg_control_respuestas[data.key] = data.value;
    },
    ...mapMutations({
