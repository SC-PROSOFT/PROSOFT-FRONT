    ...
    <v-row no-gutters>
      <v-col class="col-12">
        <h3 class="text-center">
          CONSENTIMIENTO INFORMADO PARA DILATACIÓN PUPILAR CON COLIRIOS
          MIDRIÁTICOS DE ACCIÓN CORTA
        </h3>
      </v-col>
      <v-col class="col-12">
      ...
      <v-col class="col-12">
        ...
        <v-col class="col-12">
          <h3 class="text-start">FINALIDAD</h3>
        </v-col>

        <v-col class="col-12">
          <p class="ma-0">
            Conocer a fondo la situación de los tejidos del interior del ojo
            mediante la instilación de gotas para dilatar la pupila,
            generalmente tropicamida sola o una mezcla de tropicamida más
            fenilefrina.
            <br />
            <br />
            Se considera un examen importante de realizar en cualquier patología
            retiniana, por ejemplo: retinopatía diabética, determinadas
            enfermedades maculares (miopía, degeneración macular asociada a la
            edad, edemas o encharcamientos maculares), malformaciones, procesos
            inflamatorios, tumores, etc.
            <br />
            <br />
            La técnica se realiza en consulta, y consiste habitualmente en la
            instilación previa de colirios con el fin de dilatar la pupila. Se
            espera que haga efecto el midriático (entre 10 y 30 minutos) y se
            procederá a revisar el fondo de ojo, primero con la lámpara de
            hendidura, en donde se revisa el polo posterior (con un lente de
            macula de 78 o 90 dioptrías) y luego con el oftalmoscopio indirecto,
            con el cual se revisa la media periferia (generalmente con un lente
            de 20 0 22 dioptrías).
          </p>
        </v-col>

        <v-col class="col-12">
          <h3 class="text-start">DESCRIPCIÓN DEL PROCEDIMIENTO:</h3>
        </v-col>
        <v-col class="col-12">
          <p class="ma-0">
            Como se explicó arriba, después de instilar el colirio midriático,
            se espera a que haga efecto y se procede a revisar el polo posterior
            y la periferia retiniana, obteniendo muchas veces, información
            adecuada y suficiente para hacer un diagnóstico retiniano. También
            ayuda a ver el cristalino y el segmento anterior en toda su
            dimensión con lo cual e diagnóstico de catarata es mucho más
            certero.
            <br /><br />
            Hay que tener en cuenta que, antes de aplicar los midriáticos, se
            debe medir la presión intraocular del o los ojos a dilatar. Esto
            para prevenir un aumento de la presión intraocular debido a la
            dilatación pupilar. Este fenómeno se da debido a que, al dilatarse
            la pupila, el iris se recoge como un acordeón y esto puede obstruir
            el ángulo camerular, que es el sitio por donde se drena el humor
            acuoso, con el consiguiente aumento de la presión dentro del ojo. La
            toma previa de la presión intraocular se realizará en adultos o
            niños que permitan dicha toma.
            <br /><br />
            Como molestia, el paciente queda viendo borroso de cerca durante 6 a
            8 horas (algunas veces se puede prolongar dicho efecto dependiendo
            del paciente). Por esto, el paciente siempre debe venir acompañado,
            para poder ser ayudado en su deambulación normal. Además, si es
            posible, mientras dure el efecto de los colirios midriáticos, el
            paciente debería usar lentes oscuros ya que la luz lo molestará
            mucho debido a la dilatación de sus pupilas
          </p>
        </v-col>
        <div v-if="this.paci_firma">
          <v-col class="col-12">
            <h3 class="text-start">AUTORIZACIÓN (CONSENTIMIENTO)</h3>
          </v-col>
          <v-col class="col-12">
            <p class="ma-0">
              ...
              <span class="font-weight-bold">
                ATENCIÓN MÉDICA DE COLOMBIA SAS
              </span>
