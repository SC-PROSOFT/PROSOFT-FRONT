// CONSENTIMIENTO INFORMADO PROCEDIMIENTOS - HOSPITAL ACACIAS
<template>
  <v-container>
    <v-row no-gutters>
      <v-col class="col-12">
        ...
        <v-col class="col-12 py-3 px-2">
          <table class="col-12 pa-0">
            ...
            <tbody>
              <tr>
                <td>
                  Hospitalización (área general o aislamiento respiratorio)
                </td>
                <td>
                  <v-checkbox
                    v-model="HIC014.hospit"
                    dense
                    hide-details
                    true-value="S"
                    false-value="N"
                ...
                <td>
                  Infecciones nosocomiales, caídas, deterioro clínico, muerte.
                </td>
              </tr>
              <tr>
                <td>
                  Canalización, inyectología, administración de medicamentos y
                  toma de muestras.
                </td>
                <td>
                  <v-checkbox
                    v-model="HIC014.cana_inye_adm_med"
                    dense
                    hide-details
                    true-value="S"
                    false-value="N"
                ...
                <td>
                  Dolor, infiltración, infección, cicatrices, flebitis,
                  reacciones adversas, anafilaxia, muerte.
                </td>
              </tr>
              <tr>
                <td>Sutura de heridas bajo anestesia local</td>
                <td>
                  <v-checkbox
                    v-model="HIC014.sutura_anes_loc"
                    dense
                    hide-details
                    true-value="S"
                    false-value="N"
                ...
                <td>
                  Infección, dolor, requerimiento de reintervención, sangrado,
                  resultados estéticos desfavorables, alergias.
                </td>
              </tr>
              <tr>
                <td>
                  Inserción y retiro de sondas (vesical, orogástrica,
                  nasogástrica)
                </td>
                <td>
                  <v-checkbox
                    v-model="HIC014.i_r_sondas"
                    dense
                    hide-details
                    true-value="S"
                    false-value="N"
                ...
                <td>
                  Desgarro y/o ruptura de las estructuras, hemorragia,
                  infección, edema, dolor.
                </td>
              </tr>
              <tr>
                <td>Lavado ótico/ocular/curación de heridas</td>
                <td>
                  <v-checkbox
                    v-model="HIC014.lav_otic_ocular"
                    dense
                    hide-details
                    true-value="S"
                    false-value="N"
                ...
                <td>Lesión de estructuras, dolor, infecciones.</td>
              </tr>
              <tr>
                <td>Sedación</td>
                <td>
                  <v-checkbox
                    v-model="HIC014.sedacion"
                    dense
                    hide-details
                    true-value="S"
                    false-value="N"
                ...
                <td>
                  Insuficiencia respiratoria, lesiones cerebrales, arritmias
                  cardiacas, parada cardiaca, muerte.
                </td>
              </tr>
              <tr>
                <td>Inmovilización física</td>
                <td>
                  <v-checkbox
                    v-model="HIC014.inmov_fisica"
                    dense
                    hide-details
                    true-value="S"
                    false-value="N"
                ...
                <td>Lesión de estructuras, ansiedad, agitación psicomotora.</td>
              </tr>
              <tr>
                <td>Traslado en ambulancia a otra institución</td>
                <td>
                  <v-checkbox
                    v-model="HIC014.trasl_ambul"
                    dense
                    hide-details
                    true-value="S"
                    false-value="N"
                ...
                <td>Lesiones, traumatismos, muerte.</td>
              </tr>
            </tbody>
          </table>
        </v-col>
        ...
        <!-- <v-col class="col-12 py-3 px-2">
          ...
          <p style="text-align: justify;">
            ...
            después de ser informado de la naturaleza y riesgos del
            procedimiento propuesto, manifiesto de forma libre y consciente mi
            negación/ revocación para su realización, haciéndome responsable de
            las consecuencias que se puedan derivar de ésta decisión.
          </p>
        </v-col> -->
      </v-col>
    </v-row>
  ...
  computed: {
    ...
    disable_btn_grabado() {
      if (this.firma_consen.trim()) {
        if (
          this.HIC014.maniobra_reani != "" &&
          (this.HIC014.canal_inyec == "S" ||
            this.HIC014.hospit == "S" ||
            this.HIC014.cana_inye_adm_med == "S" ||
            this.HIC014.sutura_anes_loc == "S" ||
            this.HIC014.i_r_sondas == "S" ||
            this.HIC014.lav_otic_ocular == "S" ||
            this.HIC014.sedacion == "S" ||
            this.HIC014.inmov_fisica == "S" ||
            this.HIC014.trasl_ambul == "S")
        )
          return false;
        else return true;
      } else return true;
