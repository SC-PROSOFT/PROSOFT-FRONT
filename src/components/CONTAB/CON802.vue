...
export default {
    ...
    return {
      ...
      data_table: {
        columns: [
          ...
          {
            title: "Telefono",
            body_conector: "telefono",
            cols: "2",
          },
          {
            title: "Ciudad",
            body_conector: "ciudad",
            cols: "2",
          },
          {
            title: "Actividad",
  ...
  methods: {
    ...
    async nextDataValidation(desde, cantidad, filtro) {
      await this._getTerceF8({ desde, cantidad, filtro });
      console.log("ESTA ES", this.getLista("lista").slice(0, 8));
    ...
    async consultaTerce() {
      ...
      let filtro = "";
      let cantidad = 9;
      const RES = await this._getTerceF8({ desde, cantidad, filtro });
